            ...
            <div className="space-y-4 cursor-pointer">
                {file ? (
                    <div className="uploader-selected-file" onClick={(e) => e.stopPropagation()}>
                        <img src="/images/pdf.png" alt="selected file" className="size-10" />
                    ...
                    <div>
                        ...
                        <p className="text-gray-500 text-lg">
                            <span className="font-semibold">Cliquez pour charger votre CV</span> ou glissez et déposez le ici
                        </p>
